...
Porting of the original DOOM to a Morello PureCap ABI Linux System.

To build follow the instructions provided by the [morello-pcuabi-env](https://git.morello-project.org/morello/morello-pcuabi-env/-/blob/morello/docs/docs/MORELLO-DOOM.md) SDK. 
